...
public class BUser extends BUserEntity  {
    ...
    @Override
    public void setMetaToken(String token) {                   //Added by zhang
        setMetadataString(BDefines.Keys.BFirebaseToken, token);
    }

    @Override
    public String getMetaToken() {                              //Added by zhang
        return metaStringForKey(BDefines.Keys.BFirebaseToken);
    }
